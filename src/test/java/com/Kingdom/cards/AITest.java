...
public class AITest {
	...
	public void Draw() {
		...
		Assert.assertEquals(sizeHand + 1, playerAI.SizeHand()); // test if card add to hand
	}
	...
	public void PlayCard(){
		...
		Card card1 = playerAI.PlayCard(); // Get the first card (we will play it for test)
		
		//Assert.assertEquals(true, playerAI.board.contains(card1)); // Test if card1 is place on board
		Assert.assertEquals(sizeHand - 1, playerAI.SizeHand()); // Test if size of hand decrease
		//Assert.assertEquals(sizeBoard + 1, playerAI.SizeBoard()); // Test if size of board increase
	}
	...
	public void ScoreBoard(){
		...
		//Assert.assertEquals(1, playerAI.ScoreBoard()); // Score after 1 card play
